...
const DropDown = ({ options, segment, addSegment, removeSegment }) => {
    return (
        <div className='flex items-center justify-between'>
            ...
            <select className='border border-gray-400 p-3 w-[85%] my-3' onChange={(e) => addSegment(e)}>
            ...
            }} className='flex justify-center w-10 h-10 m-auto ml-2 text-2xl bg-blue-100'>-</button>
        </div>
    )
}
